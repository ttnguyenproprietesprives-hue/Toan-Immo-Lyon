...
export default async function handler(req) {
  ...
  const prompt = `Professional real estate marketing photo. Modern residential building exterior, bright natural light, clean architecture, no people, no text, no logos, photorealistic, high quality. Warm tones, blue sky, green trees.`;
